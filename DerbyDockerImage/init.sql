...
CREATE TABLE image (
  ...
  data blob(3M) NOT NULL
);

CREATE INDEX idx_image__car_id ON image (id);
...
ALTER TABLE car_image ADD CONSTRAINT fk_image__car_id FOREIGN KEY (car_id) REFERENCES car4sale (id);
ALTER TABLE car_image ADD CONSTRAINT fk_image__image_id FOREIGN KEY (image_id) REFERENCES image (id);
...
CREATE TABLE HIBERNATE_SEQUENCES (
	...
	NEXT_VAL BIGINT,
	CONSTRAINT SQL180506180528450 PRIMARY KEY (SEQUENCE_NAME)
);
